...
description: >-
  Legacy field schema of kind `hasMany` in LinksMode: a sync reference to many
  related resources, loaded via links without adapters, usable in PolarisMode.
---

# &#x20;LinksModeHasManyField

```ts
interface LinksModeHasManyField {
  kind: "hasMany";
  name: string;
  options: { arrayExtensions?: string[]; as?: string; async: false; inverse: string | null; linksMode: true; polymorphic?: boolean };
  sourceKey?: string;
  type: string;
}
```

Defined in: [warp-drive-packages/core/src/types/schema/fields.ts:1908](https://github.com/alexraputa/warp-drive/blob/e3eb7533c9b678739ad1f65678b13bf640ce1833/warp-drive-packages/core/src/types/schema/fields.ts#L1908)
...
Defined in: [warp-drive-packages/core/src/types/schema/fields.ts:1914](https://github.com/alexraputa/warp-drive/blob/e3eb7533c9b678739ad1f65678b13bf640ce1833/warp-drive-packages/core/src/types/schema/fields.ts#L1914)
...
Defined in: [warp-drive-packages/core/src/types/schema/fields.ts:1921](https://github.com/alexraputa/warp-drive/blob/e3eb7533c9b678739ad1f65678b13bf640ce1833/warp-drive-packages/core/src/types/schema/fields.ts#L1921)
...
Defined in: [warp-drive-packages/core/src/types/schema/fields.ts:1962](https://github.com/alexraputa/warp-drive/blob/e3eb7533c9b678739ad1f65678b13bf640ce1833/warp-drive-packages/core/src/types/schema/fields.ts#L1962)
...
Defined in: [warp-drive-packages/core/src/types/schema/fields.ts:1945](https://github.com/alexraputa/warp-drive/blob/e3eb7533c9b678739ad1f65678b13bf640ce1833/warp-drive-packages/core/src/types/schema/fields.ts#L1945)
...
Defined in: [warp-drive-packages/core/src/types/schema/fields.ts:1955](https://github.com/alexraputa/warp-drive/blob/e3eb7533c9b678739ad1f65678b13bf640ce1833/warp-drive-packages/core/src/types/schema/fields.ts#L1955)
